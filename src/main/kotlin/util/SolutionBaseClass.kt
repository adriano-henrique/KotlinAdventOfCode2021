...
interface ISolution {
    ...
    fun readablePartOne(): String {
        return if(this.solvePartOne() == 0) "<NOT_IMPLEMENTED>"  else this.solvePartOne().toString()
    }

    fun readablePartTwo(): String {
        return if(this.solvePartTwo() == 0) "<NOT_IMPLEMENTED>" else this.solvePartTwo().toString()
    }
